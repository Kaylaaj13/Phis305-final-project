...
st.title(" High Blood Pressure Interactive Data Dashboard")
...
if uploaded_file is not None:
    ...
    st.subheader("Blood Pressure Data Charts")
    st.write(df.head())
    st.write(df.tail())
    
    st.subheader("Data Chart Viewer")
    ...
    st.subheader("Filter Data Chart Viewer")
    ...
    st.header("Line Chart Of slected Columns")
